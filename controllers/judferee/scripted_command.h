...
Command_Pack GYM_SCRIPTED_COMMAND(unsigned int time_step_now, int player_ask_id, int script_id){
		Command_Pack return_command = Command_Pack{player_ask_id, 0, -1000, -1000};

		if (script_id == 2){
		          if (time_step_now < 20){
		            if (player_ask_id == 0) return_command = Command_Pack{-1, 0, -1000, -1000};
		            if (player_ask_id == 11) return_command = Command_Pack{-1, 0, -1000, -1000};
		            if (player_ask_id == 8) return_command = Command_Pack{8,  8, -1000, -1000};
		          }
		          else if (player_ball[8] == 1){
		            if (player_ask_id == 0) return_command = Command_Pack{-1, 0, -1000, -1000};
		            if (player_ask_id == 11) return_command = Command_Pack{-1, 0, -1000, -1000};

		            if (player_ask_id == 8) return_command = Command_Pack{8,  9, 8, 0};
		            // if (player_ask_id == 8) return_command = Command_Pack{8,  9, grid_x[rid],grid_y[rid]};
		          }
		          else if (player_ball[11] != 1) {
		            if (player_ask_id == 0) return_command = Command_Pack{4, 0, -1000, -1000};
		            // if (player_ask_id == 11) return_command = Command_Pack{11, 0, -1000, -1000};
		            ...
		            // if (player_ask_id == 11 && return_command.player_state != 68) 
		            // {
		            // }
		            ...
		            if (player_ask_id == 8) return_command = Command_Pack{8, 0, -1000, -1000};
		          }
        }
        else if (script_id == 1)
        {
